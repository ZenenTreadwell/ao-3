...
const mutations = {
    show(state, ev){
        ...
        // let notTheseOnes = ["funds-set", "get-node-info", 'member-field-updated', 'task-touched', 'task-swapped', 'address-updated', 'invoice-created', 'task-valued', , ]
        let onlyThese = ['task-created', 'task-sub-tasked', "member-field-updated", 'task-prioritized']
